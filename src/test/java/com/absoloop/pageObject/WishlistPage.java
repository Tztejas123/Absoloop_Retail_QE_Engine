...
public class WishlistPage extends BasePage {
    ...
    public WishlistPage() { super(); this.alert = new AlertComponent(); }

    public int getWishlistCount()    { return wishlistItems.size(); }
    public boolean isWishlistEmpty() { return isDisplayed(msgEmptyWishlist, "Empty Wishlist"); }
