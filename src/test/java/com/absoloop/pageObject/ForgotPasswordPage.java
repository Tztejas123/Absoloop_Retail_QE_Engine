...
public class ForgotPasswordPage extends BasePage {
    ...
    @FindBy(xpath = "//div[contains(@class,'alert-success')]") private WebElement msgSuccess;
    @FindBy(xpath = "//div[contains(@class,'alert-danger')]")  private WebElement msgError;

    public ForgotPasswordPage() { super(); this.alert = new AlertComponent(); }
    ...
    public boolean isSuccessMessageDisplayed() { return isDisplayed(msgSuccess, "Reset Success"); }
    public boolean isErrorMessageDisplayed()   { return isDisplayed(msgError,   "Reset Error"); }
}
